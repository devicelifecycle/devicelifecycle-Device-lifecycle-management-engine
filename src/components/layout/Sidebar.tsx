...
const navSections: NavSection[] = [
  ...
  },
  {
    ...
    items: [
      ...
      { title: 'Team', href: '/var/team', icon: UserCog, roles: ['var_entity_admin', 'var_regional_manager'], tourId: 'nav-var-team' },
      { title: 'Reports', href: '/var/reports', icon: BarChart3, roles: ['var_entity_admin', 'var_regional_manager', 'var_sales_rep'], tourId: 'nav-var-reports' },
