...
const STATUS_BADGE: Record<string, string> = {
  ...
  mismatch_review:    'bg-amber-50   text-amber-700   ring-1 ring-inset ring-amber-600/20',
  ...
  payment_processing: 'bg-teal-50    text-teal-700    ring-1 ring-inset ring-teal-600/20',
  payment_sent:       'bg-emerald-50 text-emerald-700 ring-1 ring-inset ring-emerald-600/20',
